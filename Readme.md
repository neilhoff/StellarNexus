...
- Install Quasar, Quasar Icon Genie and Architect
    - `npm i -g @architect/architect @quasar/cli @quasar/icongenie`
...
- Use [Icon Genie](https://quasar.dev/icongenie/command-list#profile) to create the favicon icons
...
- Git - [Use Semantic commit messages](https://gist.github.com/joshbuchea/6f47e86d2510bce28f8e7f42ae84c716)
